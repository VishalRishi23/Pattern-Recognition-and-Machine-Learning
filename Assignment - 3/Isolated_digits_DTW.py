...
from preprocess_digits import get_features, get_symbols
...
y = pd.Series([0]*12 + [1]*12 + [2]*12 + [3]*12 + [4]*12) # Targets for dev dataset

print('Absolute path of training data of class "1": ')
a_train_dir = input() #'Hand writing data/a/train/'
print('Absolute path of training data of class "2": ')
ai_train_dir = input() #'Hand writing data/ai/train/'
print('Absolute path of training data of class "4": ')
ba_train_dir = input() #'Hand writing data/ba/train/'
print('Absolute path of training data of class "9": ')
da_train_dir = input() #'Hand writing data/da/train/'
print('Absolute path of training data of class "o": ')
la_train_dir = input() #'Hand writing data/la/train/'
train_dir = [a_train_dir, ai_train_dir, ba_train_dir, da_train_dir, la_train_dir]

print('Absolute path of dev data of class "1": ')
a_dev_dir = input() #'Hand writing data/a/dev/'
print('Absolute path of dev data of class "2": ')
ai_dev_dir = input() #'Hand writing data/ai/dev/'
print('Absolute path of dev data of class "4": ')
ba_dev_dir = input() #'Hand writing data/ba/dev/'
print('Absolute path of dev data of class "9": ')
da_dev_dir = input() #'Hand writing data/da/dev/'
print('Absolute path of dev data of class "o": ')

...
from preprocess_writing import get_features, get_symbols, write_seq
...
classes = [0, 1, 2, 3, 4]
y = pd.Series([0]*20 + [1]*20 + [2]*20 + [3]*20 + [4]*20) # Targets for dev set
n_clusters = 30 # No. of clusters - for VQ
STATES = 20 # No. States in the HMM
SYMBOLS = n_clusters # No.of Symbols in the HMM
SEED = 42

print("Absolute path to the training dataset of class 'a': ")
a_train_dir = input() #'./Documents/ML_PATH/PRML/Assignment - 3/Isolated digits/1/train/'
print("Absolute path to the training dataset of class 'ai': ")
ai_train_dir = input() #'./Documents/ML_PATH/PRML/Assignment - 3/Isolated digits/2/train/'
print("Absolute path to the training dataset of class 'ba': ")
ba_train_dir = input() #'./Documents/ML_PATH/PRML/Assignment - 3/Isolated digits/4/train/'
print("Absolute path to the training dataset of class 'da': ")
da_train_dir = input() #'./Documents/ML_PATH/PRML/Assignment - 3/Isolated digits/9/train/'
print("Absolute path to the training dataset of class 'la': ")
